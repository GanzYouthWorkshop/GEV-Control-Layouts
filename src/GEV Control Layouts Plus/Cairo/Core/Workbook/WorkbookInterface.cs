...
#if WINFORM || WPF
using ControlType = GEV.Layouts.Extended.Cairo.CairoSpreadsheet;
#elif ANDROID
using ControlType = GEV.Layouts.Extended.Cairo.ReoGridView;
#endif // ANDROID
...
namespace GEV.Layouts.Extended.Cairo
{
...
#endif // WINFORM || WPF
	{
		...
		void Save(System.IO.Stream stream, GEV.Layouts.Extended.Cairo.IO.FileFormat fileFormat);
		...
		void Save(System.IO.Stream stream, GEV.Layouts.Extended.Cairo.IO.FileFormat fileFormat, Encoding encoding);
		...
		void Load(System.IO.Stream stream, GEV.Layouts.Extended.Cairo.IO.FileFormat fileFormat);
		...
		/// <param name="fileFormat">Specified file format used to read workbook data from stream.</param>
		/// <param name="encoding">Encoding used to read plain-text format workbook data from stream. (Optional)</param>
		void Load(System.IO.Stream stream, GEV.Layouts.Extended.Cairo.IO.FileFormat fileFormat, Encoding encoding);
