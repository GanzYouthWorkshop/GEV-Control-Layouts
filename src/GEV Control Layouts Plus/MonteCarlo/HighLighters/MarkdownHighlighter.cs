...
{
    public class MarkdownHighlighter : SyntaxHighlighterBase
    {
        /*
         * H1
         * H2
         ...
         * 
         * */
        protected Regex H1Regex = new Regex(@"^#{1} .+$", RegexOptions.Singleline | RegexCompiledOption);
        protected Regex H2Regex = new Regex(@"^#{2} .+$", RegexOptions.Singleline | RegexCompiledOption);
        protected Regex H3Regex = new Regex(@"^#{3} .+$", RegexOptions.Singleline | RegexCompiledOption);
        protected Regex H4Regex = new Regex(@"^#{4} .+$", RegexOptions.Singleline | RegexCompiledOption);
        protected Regex H5Regex = new Regex(@"^#{5} .+$", RegexOptions.Singleline | RegexCompiledOption);
        protected Regex H6Regex = new Regex(@"^#{6} .+$", RegexOptions.Singleline | RegexCompiledOption);

        protected Regex BoldRegex = new Regex(@"^\*\*.+?\*\*$", RegexOptions.Multiline | RegexCompiledOption);
        protected Regex ItalicRegex = new Regex(@"^\*.+?\*$", RegexOptions.Multiline | RegexCompiledOption);
        protected Regex UnderlineRegex = new Regex(@"^__.+?__$", RegexOptions.Multiline | RegexCompiledOption);
        protected Regex StrikethroughRegex = new Regex(@"^~~.+?~~$", RegexOptions.Multiline | RegexCompiledOption);
