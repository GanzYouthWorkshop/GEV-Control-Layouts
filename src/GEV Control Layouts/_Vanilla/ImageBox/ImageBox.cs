...
namespace GEV.Layouts.Vanilla
{
  ...
  /* [Designer("Cyotek.Windows.Forms.Design.ImageBoxDesigner", Cyotek.Windows.Forms.ImageBox.Design.dll, PublicKeyToken=58daa28b0b2de221")] */ public class ImageBox : VirtualScrollableControl
  {
    ...
    private ImageBoxGridDisplayModes _gridDisplayMode;

    private ImageBoxGridScales _gridScale;
    ...
    private ImageBoxBorderStyles _imageBorderStyle;
    ...
    private ImageBoxSelectionModes _selectionMode;
    ...
    private ImageBoxSizeModes _sizeMode;
    ...
    private ImageBoxGridDisplayModes _textDisplayMode;
    ...
    public ImageBox()
    {
      ...
      this.ImageBorderStyle = ImageBoxBorderStyles.None;
      this.BackColor = Color.White;
      this.AutoSize = false;
      this.AutoScroll = true;
      this.GridScale = ImageBoxGridScales.Small;
      this.GridDisplayMode = ImageBoxGridDisplayModes.Client;
      ...
      this.TextDisplayMode = ImageBoxGridDisplayModes.Client;
      this.EndUpdate();
    ...
    [DefaultValue(ImageBoxGridDisplayModes.Client)]
    [Category("Appearance")]
    public virtual ImageBoxGridDisplayModes GridDisplayMode
    {
    ...
    [DefaultValue(typeof(ImageBoxGridScales), "Small")]
    [Category("Appearance")]
    public virtual ImageBoxGridScales GridScale
    {
    ...
    [Category("Appearance")]
    [DefaultValue(typeof(ImageBoxBorderStyles), "None")]
    public virtual ImageBoxBorderStyles ImageBorderStyle
    {
    ...
    /// </value>
    [Category("Behavior")]
    [DefaultValue(typeof(ImageBoxSelectionModes), "None")]
    public virtual ImageBoxSelectionModes SelectionMode
    {
    ...
    [Category("Behavior")]
    [DefaultValue(typeof(ImageBoxSizeModes), "Normal")]
    public virtual ImageBoxSizeModes SizeMode
    {
    ...
    {
      get { return this.SizeMode == ImageBoxSizeModes.Fit; }
      set
      {
        if (this.SizeMode == ImageBoxSizeModes.Fit != value)
        {
          this.SizeMode = value ? ImageBoxSizeModes.Fit : ImageBoxSizeModes.Normal;
    ...
    [Category("Appearance")]
    [DefaultValue(typeof(ImageBoxGridDisplayModes), "Client")]
    public virtual ImageBoxGridDisplayModes TextDisplayMode
    {
    ...
    public virtual Rectangle GetImageViewPort()
    {
      ...
      if (!this.ViewSize.IsEmpty)
      {
        ...
        if (this.SizeMode != ImageBoxSizeModes.Stretch)
        {
          if (this.AutoCenter)
          {
            int x;
    ...
    protected virtual void AdjustLayout()
    {
      if (this.AllowPainting)
      {
        ...
        else if (this.SizeMode != ImageBoxSizeModes.Normal)
        {
          this.ZoomToFit();
        }
    ...
    protected virtual Bitmap CreateGridTileImage(int cellSize, Color firstColor, Color secondColor)
    {
      ...
      {
        case ImageBoxGridScales.Medium:
          scale = 1.5F;
          break;

        case ImageBoxGridScales.Large:
          scale = 2;
          break;

        case ImageBoxGridScales.Tiny:
          scale = 0.5F;
          break;
    ...
    protected virtual void DrawBackground(PaintEventArgs e)
    {
      ...
      if (_texture != null && this.GridDisplayMode != ImageBoxGridDisplayModes.None)
      {
        switch (this.GridDisplayMode)
        {
          case ImageBoxGridDisplayModes.Image:
          ...
          case ImageBoxGridDisplayModes.Client:
    ...
    {
      if (this.ImageBorderStyle != ImageBoxBorderStyles.None)
      {
        Rectangle viewPort;
        ...
        {
          case ImageBoxBorderStyles.FixedSingleDropShadow:
            this.DrawDropShadow(graphics, viewPort);
            break;
          case ImageBoxBorderStyles.FixedSingleGlowShadow:
    ...
    protected virtual void DrawText(PaintEventArgs e)
    {
      ...
      bounds = this.TextDisplayMode == ImageBoxGridDisplayModes.Client ? this.GetInsideViewPort() : this.GetImageViewPort();
    ...
    protected virtual int GetImageBorderOffset()
    {
      ...
      switch (this.ImageBorderStyle)
      {
        case ImageBoxBorderStyles.FixedSingle:
          offset = 1;
          break;
    ...
    protected override void OnKeyDown(KeyEventArgs e)
    {
      ...
      if (this.ShortcutsEnabled && this.AllowZoom && this.SizeMode == ImageBoxSizeModes.Normal)
      {
    ...
    protected override void OnMouseUp(MouseEventArgs e)
    {
      ...
      if (!doNotProcessClick && this.AllowZoom && this.AllowClickZoom && !this.IsPanning && this.SizeMode == ImageBoxSizeModes.Normal)
      {
    ...
    protected override void OnMouseWheel(MouseEventArgs e)
    {
      ...
      if (this.AllowZoom && this.SizeMode == ImageBoxSizeModes.Normal)
      {
        int spins;
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
      if (this.AllowPainting)
      {
        ...
        // text
        if (!string.IsNullOrEmpty(this.Text) && this.TextDisplayMode != ImageBoxGridDisplayModes.None)
        {
          this.DrawText(e);
        }
    ...
    protected virtual void OnSelected(EventArgs e)
    {
      ...
      {
        case ImageBoxSelectionModes.Zoom:
    ...
    {
      if (this.AutoPan && !this.ViewSize.IsEmpty && this.SelectionMode == ImageBoxSelectionModes.None)
      {
    ...
    {
      if (this.SelectionMode != ImageBoxSelectionModes.None && e.Button == MouseButtons.Left && !this.WasDragCancelled)
      {
        if (!this.IsSelecting)
        {
          this.StartDrag(e);
    ...
    {
      if (this.SizeMode != ImageBoxSizeModes.Normal)
      {
        int previousZoom;

        previousZoom = this.Zoom;
        this.SizeMode = ImageBoxSizeModes.Normal;
    ...
    private void InitializeGridTile()
    {
      ...
      if (this.GridDisplayMode != ImageBoxGridDisplayModes.None && this.GridCellSize != 0)
      {
        if (this.GridScale != ImageBoxGridScales.None)
        {
